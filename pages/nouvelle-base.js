...
const NAF_SECTORS = {
  ...
  "💄 Cosmétique & Beauté": [
    ...
    ["46.45Z","Commerce de gros parfumerie et beauté"],
    ["47.75Z","Commerce détail parfumerie et beauté"],
    ["96.02A","Coiffure"],
    ["96.02B","Soins de beauté / esthétique"],
    ["96.04Z","Entretien corporel (spas, bien-être)"],
    ["47.71Z","Commerce détail habillement"],
    ["46.18Z","Agents spécialisés (cosmétiques, pharmacie)"],
  ],
  "🌿 Agro-alimentaire & Luxe": [
    ["10.89Z","Autres industries alimentaires"],["11.01Z","Spiritueux"],
    ["11.02A","Vins AOC"],["11.02B","Autres vins"],
    ["46.17Z","Agents en denrées alimentaires"],
    ["15.11Z","Apprêt et tannage des cuirs (maroquinerie)"],
    ["15.12Z","Articles de voyage, maroquinerie"],
    ["14.19Z","Fabrication d'autres vêtements (mode, luxe)"],
    ["32.12Z","Bijouterie, joaillerie, orfèvrerie"],
    ["47.77Z","Commerce détail horlogerie bijouterie"],
  ],
  "⚙️ Services B2B": [
