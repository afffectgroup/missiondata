        ...
        <div style={{ background: 'white', borderRadius: '16px', padding: '32px', border: '1px solid var(--border)', boxShadow: '0 4px 24px rgba(0,0,0,.06)' }}>
          ...
          <form onSubmit={handleLogin}>
            ...
            <button
              type="submit"
              disabled={loading}
              style={{ width: '100%', padding: '12px', background: loading ? '#93b4fb' : 'var(--mf-blue)', color: 'white', border: 'none', borderRadius: '99px', fontSize: '14px', fontWeight: '600', cursor: loading ? 'not-allowed' : 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', transition: 'background .15s', fontFamily: 'inherit' }}>
