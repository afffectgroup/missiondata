      ...
      <aside style={{ width: '240px', background: 'white', borderRight: '1px solid var(--border)', display: 'flex', flexDirection: 'column', flexShrink: 0, position: 'sticky', top: 0, height: '100vh' }}>
        ...
        <div style={{ padding: '20px 16px 16px', borderBottom: '1px solid var(--border)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <div>
              <div style={{ fontSize: '14px', fontWeight: '700', color: 'var(--text)' }}>Mission Freelances</div>
              <div style={{ fontSize: '11px', color: 'var(--muted)' }}>Mission Data</div>
            </div>
          </div>
        </div>
        ...
        <nav style={{ flex: 1, padding: '12px 8px' }}>
          ...
          <button
            ...
            Mes dossiers
            <span style={{ marginLeft: 'auto', background: 'var(--mf-blue)', color: 'white', borderRadius: '20px', padding: '1px 7px', fontSize: '11px' }}>{campaigns.length}</span>
          </button>
        </nav>
        ...
        <div style={{ padding: '12px 8px', borderTop: '1px solid var(--border)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', padding: '8px 10px', borderRadius: 'var(--r)', marginBottom: '4px' }}>
            <div style={{ width: '28px', height: '28px', background: 'var(--mf-blue)', borderRadius: '50%', display: 'grid', placeItems: 'center', fontSize: '12px', fontWeight: '700', color: 'white', flexShrink: 0 }}>
              {name[0].toUpperCase()}
            </div>
